...
| 2  | Run          | [systems/run.md](systems/run.md)             | `systems/run/`          | MVP          | 2026-07-20   | M7: flat talent-point reward on non-forfeit run end (RunSummary.talent_points_awarded). |
| 3  | Player       | [systems/player.md](systems/player.md)       | `systems/player/`       | MVP          | 2026-07-20   | M7: applies permanent Talent effects at spawn before deriving health/mana. |
...
| 12 | Skills       | [systems/skills.md](systems/skills.md)       | `systems/skills/`       | MVP          | 2026-07-20   | M7: TalentManager autoload, TalentData/TalentTreeData, 3 trees, permanent effects + spell unlocks. |
...
| 16 | Save         | [systems/save.md](systems/save.md)           | `systems/save/`         | MVP          | 2026-07-20   | M7: saveable registry wired into profile.json; talents section (points, ranks, GM). |
| 17 | UI           | [systems/ui.md](systems/ui.md)               | `systems/ui/`           | MVP          | 2026-07-20   | M7: WotLK-style Talent Tree screen (grid, arrows, rank badges, tooltips, reset + GM); Character Stats permanent column; Run Summary talent points. |
...
Active milestone: **M8 — Vertical Slice** (see [ROADMAP.md](ROADMAP.md)). M0–M7 are Done.

**M7 completed:** Talent Trees & Meta-Progression on branch `m7-talent-meta-progression` — `TalentManager` autoload, `TalentData`/`TalentTreeData` resources, 3 trees (Ember/Frost/Arcane, 10 talents each) with permanent stat modifiers and 6 talent-granted spell unlocks, WotLK-style Talent Tree UI (tiered grid, rank badges, arrows, tooltips, reset + game-master controls), profile save of talent progression via the saveable registry, and a flat talent-point reward on completed runs.
...
- v0.18 - M7 Talent Trees & Meta-Progression: TalentManager autoload, TalentData/TalentTreeData, 3 trees with permanent modifiers + spell unlocks, WotLK-style Talent Tree UI, profile talent save via saveable registry, flat post-run talent points. Active milestone advanced to M8.
